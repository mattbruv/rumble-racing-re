...
// ReorderArray takes a flat array of 256 elements (data) and reorders them
// into a new 1D slice (length 256) according to the CLUT indexing scheme.
func ReorderArray[T any](data []T) ([]T, error) {
	if len(data) != 256 {
		var zeroSlice []T
